...
import { setLogout } from "../redux/slice/userSlice"; // Import logout action
  ...
  const handleLogoutAndRedirect = async () => {
    try {
      ...
      if (response?.data?.status === 1) {
        ...
        // Notify the user about the successful logout
        toast.success("You have logged out successfully.");

        // Navigate to the login page (or home page depending on your app flow)
        navigate("/sign-in"); // Change this if you want to redirect to a different page
      } else {
